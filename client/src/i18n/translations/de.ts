const de: Record<string, string> = {
  ...
  'places.searchInMap': 'In Karte nach "{query}" suchen',
  ...
  'places.googleFallback': 'Google Places nicht verfügbar. OpenStreetMap-Ergebnisse werden verwendet.',
  ...
  'inspector.duplicateInDay': 'Im Tag duplizieren',
